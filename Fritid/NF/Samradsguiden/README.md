...
- `data.js` — all sakdata verktyget använder: de åtta dispositionsmallarna (PBL detaljplan × 3 skeden, PBL översiktsplan × 2 skeden, MB × 3 skeden) och kompensationsmodulens tre rättsliga spår × två lägen.
